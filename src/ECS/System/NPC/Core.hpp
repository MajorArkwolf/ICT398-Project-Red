...
namespace System {
     ...
     */
void NPCInit(entt::entity& entity);
     ...
     * @param [in,out] entity The target Entity.
     */
void NPCUnInit(entt::entity& entity);
     ...
     */
void NPCImport(entt::entity& entity, std::string path);
     ...
     * @param [in] path The filesystem path to the target external file.
     */
void NPCExport(entt::entity& entity, std::string path);
...
void NPCRespond(entt::registry& registry, entt::entity& entity);
     ...
     * @param [in] dt The delta time (time step) from previous update.
     */
