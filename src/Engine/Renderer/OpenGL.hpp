...
namespace view {
    ...
    public:
         ...
         */
        static unsigned int TextureFromFile(const std::string &path, const std::filesystem::path &directory,
    ...
    private:
        ...
        std::shared_ptr<Shader> model_shader_ = nullptr;
        std::shared_ptr<Shader> light_shader_ = nullptr;
        /**
